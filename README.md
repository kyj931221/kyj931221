...
✨ [중요 업무]
- IoT / ICT 제품 기획, 연구, 개발, 테스트
- 스마트팜, 무선 컨트롤 시스템, 국가 과제 사업 수행

📌 [(주)엠스텍, 사원] - 2025년 03월 ~ 2025년 05월 (2개월) <br>
✨ [중요 업무]
- 삼성 웰스토리 APP 기능 고도화 프로젝트
- 관리자 시스템(BO) 및 사용자 환경(FO)의 테스트 케이스 작성 및 데이터 적합성과 기능 동작 테스트 진행
...
<!-- 🖼️ 로고  -->
    <td>
      <img src="https://github.com/Polytechnics-Team-One/Antarctic-exploration/blob/dev/assets/Images/%EB%8D%B8%EB%A6%AC%EC%95%84%EC%9D%98%20%EB%82%A8%EA%B7%B9%ED%83%90%ED%97%98.png" width="100" />
    </td>
<!-- 📌 프로젝트 이름  -->  
    <td>
      <div align="center">
...
<!-- 📄 설명  -->
    <td>
      트릭컬 팬 게임 : 컨트롤을 통해 위에서 내려오는 장애물을 피하고 오른쪽에서 날라오는 아이템을 먹어서 점수를 획득하!
    </td>
<!-- 유튜브 깃허브  -->    
    <td>
      <a href=" ">
      ...
      <br>
      <a href="https://github.com/Polytechnics-Team-One/Antarctic-exploration">
        <img src="https://img.shields.io/badge/github-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" style="vertical-align: middle; width: 80px; height: 20px;">
      </a>
    </td>
